...
namespace NationRegion.Data
{
    public class RegionDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var dbPath = Path.Combine(currentPath.Substring(0, projectIndex), projectName + "\\Data\\Region_201910.db");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Region>().Property(c => c.CreationTime).ValueGeneratedOnAdd();
